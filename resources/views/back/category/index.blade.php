                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{route('category.edit',$eid)}}"><button class="btn btn-info btn-sm"><i class="fas fa-edit"></i></button></a>
                                    <form action="{{ route('category.destroy', $eid) }}" class="inline_form" method="post">
                                        @csrf
                                        @method('DELETE')
