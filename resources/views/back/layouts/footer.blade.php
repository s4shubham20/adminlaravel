...
<script src="{{asset('assets/back/plugins/bootstrap4-duallistbox/jquery.bootstrap-duallistbox.min.js')}}"></script>
<!-- InputMask -->
...
<!-- Bootstrap Switch -->
<script src="{{asset('assets/back/plugins/bootstrap-switch/js/bootstrap-switch.min.js')}}"></script>
<!-- BS-Stepper -->
<script src="{{asset('assets/back/plugins/bs-stepper/js/bs-stepper.min.js')}}"></script>
<!-- dropzonejs -->
...
<script src="{{asset('assets/back/dist/js/custom.js')}}"></script>
